...
export function TextToSpeechDetailView({
  ...
  /**
   * Use the denormalized voiceName snapshot instead of a populated voice relation so the preview always shows the voice name at the
   * time of the generation (even if the voice was later renamed or deleted)
   */
